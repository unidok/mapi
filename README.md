...
- [version](###version)
4. [Команды](#Команды)
5. [Структура команды](#Структура-команды)
6. [Обработка команд](#Обработка-команд)
7. [Структура аргументов команд](#Структура-аргументов-команд)
8. [Настройки команды](#Настройки-команды)
